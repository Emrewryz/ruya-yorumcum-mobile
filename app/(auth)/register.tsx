...
function GoogleIcon() {
  return (
    <View style={g.iconWrap}>
      <Text style={g.iconTxt}>G</Text>
    </View>
  );
}

const g = StyleSheet.create({
  iconWrap: { width: 20, height: 20, borderRadius: 10, backgroundColor: "#fff", alignItems: "center", justifyContent: "center" },
  iconTxt:  { fontSize: 13, fontWeight: "800", color: "#4285F4" },
});
...
export default function RegisterScreen() {
  ...
  const handleGoogle = async () => {
    ...
    // Google ile ilk kayıtta onboarding'e gönder
    router.replace("/onboarding");
  };
...
const s = StyleSheet.create({
  ...
  googleBtn:  { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 10, backgroundColor: "#18181b", borderRadius: 14, paddingVertical: 15, marginBottom: 20 },
  googleTxt:  { fontSize: 15, fontWeight: "600", color: "#fff" },
  ...
  switchRow:  { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 6, marginBottom: 20 },
